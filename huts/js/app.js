...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(56.093580, 10.217973)],
	]
	var options = {
		zoom: 10,
		panControl: false,
...
//========================================================================================================================================================
let bookingSlider = new Swiper('.booking-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
	...
	speed: 800,
	navigation: {
		nextEl: '.control-booking-slider__arrow_next'
	},
	speed: 800,
	loop: true,
});
...
if (langHeaderCurrent != null) {
	let delay = 500;
	let langHeaderItem = document.querySelector(".lang-header__items");
	langHeaderCurrent.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			langHeaderCurrent.classList.toggle("_active");
			langHeaderItem.classList.toggle("_active");
		}
	});
	document.addEventListener("click", function (e){
		if(!e.target.classList.contains('lang-header__current') && !e.target.classList.contains('lang-header__items')){
			...
			langHeaderItem.classList.remove("_active");
		}
	});
}; 
//========================================================================================================================================================
...
//========================================================================================================================================================
let langPersonalCurrent = document.querySelector(".lang-personal__current");
if (langPersonalCurrent != null) {
	let delay = 500;
	let langPersonalItem = document.querySelector(".lang-personal__items");
	langPersonalCurrent.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			langPersonalCurrent.classList.toggle("_active");
			langPersonalItem.classList.toggle("_active");
		}
	});
	document.addEventListener("click", function (e){
		if(!e.target.classList.contains('lang-personal__current') && !e.target.classList.contains('lang-personal__items')){
			langPersonalCurrent.classList.remove("_active");
			langPersonalItem.classList.remove("_active");
		}
	});
}; 
//========================================================================================================================================================
let blogCard = new Swiper('.blog-card__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	autoHeight: true,
	speed: 800,
	navigation: {
		nextEl: '.blog-card__arrow_next',
		prevEl: '.blog-card__arrow_prev'
	},
	loop: true,
});
//========================================================================================================================================================
let blogCardRow = new Swiper('.blog-card__slider-row', {
	navigation: {
		nextEl: '.blog-card__row_next',
		prevEl: '.blog-card__row_prev'
	},
	loop: true,
	observer: true,
	observeParents: true,
...
//========================================================================================================================================================
let blogCardPrac = new Swiper('.blog-card__slider-prac', {
	navigation: {
		nextEl: '.blog-card__prac_next',
		prevEl: '.blog-card__prac_prev'
	},
	loop: true,
	observer: true,
	observeParents: true,
...
//========================================================================================================================================================
let blogCardActiv = new Swiper('.blog-card__slider-activ', {
	navigation: {
		nextEl: '.activ_next',
		prevEl: '.activ_prev'
	},
...
//========================================================================================================================================================
let blogExperie = new Swiper('.blog-card__body_row-experie', {
	navigation: {
		nextEl: '.experie_next',
		prevEl: '.experie_prev'
	},
